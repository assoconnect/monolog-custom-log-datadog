...
use AssoConnect\MonologDatadog\MonologHandler;
...
final class MonologHandlerTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->monologHandler = new MonologHandler(self::ENDPOINT, self::API_KEY, $this->guzzle);

        $this->logger = new Logger('phpunit');
        $this->logger->pushHandler($this->monologHandler);
    }
